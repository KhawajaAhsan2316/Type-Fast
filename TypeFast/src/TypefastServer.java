...
public class TypefastServer {
    ...
    private static final String WORDS_FILE_PATH = "C:\\Users\\RITHIK\\OneDrive\\Desktop\\untitled\\src\\words.txt";// You can change this to an absolute path
    ...
    private static class ClientHandler implements Runnable {
            ...
            switch (command) {
                ...
                case "SCOREBOARD":
                    if (username != null) {
                        ...
                        sendMessage("You must be logged in to view the scoreboard.");
                    }
                    break;
                case "EXIT":
                    setExitFlag();
                    ...
                    break;
                default:
                    if (message.equalsIgnoreCase(currentWord) && !wordTypedCorrectly) {
                        ...
                        sendMessage("Incorrect word or you already typed it correctly.");
                    }
                    break;
            }
        }
        ...
        private void sendScoreboard() {
            ...
            for (Map.Entry<String, ClientHandler> entry : authenticatedUsers.entrySet()) {
                ...
                int score = entry.getValue().totalScore;
                scoreboard.append(user).append(": ").append(score).append("\n");
            }

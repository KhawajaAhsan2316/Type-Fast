...
public class TypefastClient {
    private static final String SERVER_ADDRESS = "192.168.0.133";  // Change this to the server's public IP if needed
    ...
    private void createAndShowGUI() {
        ...
        userInputField.setPreferredSize(new Dimension(50,50));
